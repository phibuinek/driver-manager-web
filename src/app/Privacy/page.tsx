...
3.1. Hỗ trợ ứng dụng: DriveManager sử dụng thông tin 
thu thập được để cung cấp.duy trì và cải thiện các tính năng 
của DriveManager. Bao gồm:
3.1.1. Tự động cập nhật các thông tin cá nhân (Họ tên, 
Tên Doanh nghiệp, Email, SDT, Địa chỉ) của Người Sử Dụng 
trong quá trình điền các trường thông tin trên ứng dụng.
3.1.2. Ghi nhớ thông tin để Người Sử Dụng không phải 
nhập lại trong quá trình truy cập hoặc lần tiếp theo khi Người 
Sử Dụng truy cập.
3.1.3. Tự động cập nhật Ứng dụng DriveManager trên 
thiết bị của Người Sử Dụng, xử lý lỗi phần mềm, các sự cố hoạt 
động, phân tích dữ liệu, kiểm nghiệm và nghiên cứu.
3.2. An toàn và an ninh:
DriveManager sử dụng dữ liệu thông tin của Người Sử 
Dụng để duy trì sự an toàn, an ninh và tính toàn vẹn cho ứng 
dụng DriveManager.
3.3. Hỗ trợ khách hàng: Trong trường hợp Người Sử 
...
gọi hỗ trợ, chăm sóc khách hàng để:
3.3.1. Giải quyết các thắc mắc, khiếu nại của Người Sử 
Dụng.
3.3.2. Theo dõi và hỗ trợ khách hàng trong quá trình sử 
dụng dịch vụ.
3.4. Nghiên cứu và phát triển: DriveManager có thể sử 
...
mới;
3.5. Trao đổi từ DriveManager: DriveManager có thể sử 
...
gồm:
3.5.1. Gửi tin nhắn (SMS) hoặc gọi điện đến số điện thoại 
của Người Sử Dụng theo thông tin DriveManager thu thập được
từ Người Sử Dụng;
3.5.2. Gửi thư điện tử đến địa chỉ thư điện tử của Người 
Sử Dụng theo thông tin DriveManager thu thập được từ Người 
Sử Dụng;
3.6. Thực hiện các thủ tục và yêu cầu pháp lý 
DriveManager có thể sử dụng thông tin thu thập được để
3.6.1. Điều tra hoặc giải quyết các khiếu nại hoặc tranh 
...
- Email đăng ký
- Tên doanh nghiệp
- Mã số doanh nghiệp và MST (nếu tổ chức có MST khác 
mã số doanh nghiệp)
- Địa chỉ doanh nghiệp
- Email liên hệ 
- Số điện thoại thông tin về người đại diện hợp pháp của 
tổ chức{' '}
4.2. Thông tin được DriveManager gửi cho Người Sử
Dụng
4.2.1.Liên hệ với DriveManager qua tổng đài, ứng dụng, 
trang web và tài khoản mạng xã hội;
4.2.2. Kích hoạt các tính năng cho phép DriveManager 
truy cập vào ảnh hoặc vị trí thiết bị của Người Sử Dụng.
4.3. Thông tin được tạo ra khi Người Sử Dụng dùng 
ứng dụng DriveManager
4.3.1. Cập nhật thông tin Tài Khoản DriveManager.
4.3.2. Nếu được Người Sử Dụng cho phép, DriveManager 
...
tự động hiển thị vị trí của Người Sử Dụng trên bản đồ;
4.3.3. Thông tin sử dụng và tùy chọn: DriveManager thu 
...
Người Sử Dụng;
4.3.4. Thông tin sử dụng và tùy chọn: DriveManager thu 
thập thông tin về cách Người Sử Dụng tương tác với ứng dụng 
của DriveManager, các tùy chọn và thiết lập được chọn. Trong 
một số trường hợp DriveManager thu thập thông tin thông qua 
việc sử dụng các cookie, thẻ điểm ảnh và các công nghệ tương 
tự cho phép tạo và duy trì các mã nhận diện duy nhất của 
Người Sử Dụng;
4.3.5. Thông tin thiết bị: DriveManager có thể thu thập 
...
cáo, số seri và thông tin mạng di động;
4.3.6. Thông tin lịch sử cập nhật: Khi Người Sử Dụng 
tương tác với ứng dụng DriveManager, DriveManager thu thập 
nhật ký máy chủ, có thể bao gồm các thông tin như thời gian, 
hành động, tài khoản thực hiện,...
4.4 Các thông tin khác DriveManager cần thu thập 
nhằm tuân thủ nghĩa vụ pháp lý
DriveManager sẽ yêu cầu Người Sử Dụng cung cấp các 
thông tin liên quan đến việc sử dụng ứng dụng của 
DriveManager mà DriveManager có thể yêu cầu một cách hợp 
lý cho các mục đích sau đây:
4.4.1. Trợ giúp DriveManager tuân thủ các nghĩa vụ của 
mình theo quy định pháp luật;
4.4.2. Báo cáo các cơ quan nhà nước có thẩm quyền theo
quy định;
...
với Người Sử Dụng theo quy định của Chính Sách này.
5.2.2. Với công chúng khi Người Sử Dụng gửi nội dung lên
...
mạng xã hội khác.
5.2.3. Theo quy định của pháp luật hiện hành hoặc theo 
yêu cầu của cơ quan nhà nước có thẩm quyền, bao gồm:
- Chia sẻ cho các cơ quan tiến hành tố tụng, các cơ quan 
quản lý hành chính;
- Thực hiện các báo cáo định kỳ, đột xuất theo quy định 
của các cơ quan quản lý nhà nước khác;
...
6.2. Dừng nhận bản tin tiếp thị trên email: Người Sử 
...
7.2. DriveManager sẽ thực hiện các biện pháp an ninh 
...
7.3. DriveManager sẽ lưu giữ dữ liệu thông tin của Người 
...
biện pháp đó.
8.2. Trong trường hợp bất kỳ quy định nào của Chính 
...
8.3. Người Sử Dụng xác nhận rằng DriveManager, theo 
các quy
định pháp luật và quy định hiện hành hoặc sau khi nhận được 
...
8.4. Chính Sách này sẽ có giá trị ràng buộc đối với những
...
8.5. Bất kỳ tranh chấp hoặc bất đồng nào theo Chính 
...
8.6. Tranh chấp giữa Người Sử Dụng và bên thứ ba: 
