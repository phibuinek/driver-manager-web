...
const Navbar = () => {
    return (
        <div>
          <div className="fixed flex bg-white top-0 left-0 right-0 z-50">
              <Link href="/">
              ...
              <h1 className='text-primary text-lg mx-0 mt-4 font-bold'>Driver </h1>
              <h1 className='text-primary text-lg mx-0 mb-4 font-bold'>Management</h1>
              </div>
              ...
              <div className=" my-5 mx-4 text-gray-300 border-2 border-gray-300 bg-white px-4 rounded-full text-base w-96 h-9 relative pt-1">
                ...
                <div className="ml-96 border-solid border-2 border-primary bg-primary w-[10px] overflow-hidden"></div>
                <button type="submit" className=" my-5 mx-5 pb-2">
                ...
                <button type="submit" className=" my-1 mx-5 pb-2 flex">
                    ...
                    <div className="text-primary mx-4 mt-1">username</div>
                    <Image className="ml-0 max-w-none max-h-none my-1" src={require("/public/assets/arrow.png")} width={24} height={12} alt="Scroll down"></Image>
                </button>
