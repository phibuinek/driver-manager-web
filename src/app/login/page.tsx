...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-evenly items-center bg-primary mt-20">
      <Image  src={require("/public/assets/image 1.svg")} width={239} height={181} alt='bigLogo'></Image>
      <Formik
      ...
      >
        {({ isSubmitting }) => (
          <Form className="bg-white border-solid border-4 rounded-2xl border-login shadow-xl shadow-green-100 mix-blend-darken px-8 pt-6 pb-8 mb-4 mt-10">
            ...
            <div className="mb-4 mt-9">
              ...
              <div className="inline-flex text-sm appearance-none border-b-2 border-login w-full pb-2 text-gray-300 leading-tight focus:outline-none focus:shadow-outline">
                <Image className="" src ={require("/public/assets/Icon.png")} width={17} height={17} alt='Username'></Image>
              <Field
            ...
            <div className="my-10">
              ...
              <div className="inline-flex text-sm appearance-none border-b-2 border-login w-full pb-2 text-gray-300 leading-tight focus:outline-none focus:shadow-outline">
                <Image className="" src ={require("/public/assets/lock-02.png")} width={17} height={17} alt='Username'></Image>
              <Field
